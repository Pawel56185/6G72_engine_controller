...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, STEP_1_Pin|STEP_2_Pin|STEP_3_Pin|STEP_4_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : BASE_Pin HOME_Pin STEPPER_LEFT_Pin STEPPER_RIGHT_Pin */
  GPIO_InitStruct.Pin = BASE_Pin|HOME_Pin|STEPPER_LEFT_Pin|STEPPER_RIGHT_Pin;
